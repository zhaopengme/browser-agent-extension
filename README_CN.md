...
1. 下载 [browser-agent-extension-v1.0.4.zip](https://github.com/agents-cc/browser-agent-extension/releases/download/v1.0.4/browser-agent-extension-v1.0.4.zip)
2. 解压到任意文件夹
